...
ActiveRecord::Schema.define(:version => 20131111203342) do
  ...
  add_index "follows", ["twitter_followee_id"], :name => "index_follows_on_twitter_followee_id", :unique => true
  add_index "follows", ["twitter_follower_id"], :name => "index_follows_on_twitter_follower_id", :unique => true
